...
const MessageInputPlainTextarea = ({
  ...
  return (
    <textarea
      ...
      onPaste={handlePaste}
      className={cn(
        "flex-1 p-3 rounded-t-lg bg-background text-foreground resize-none text-sm min-h-[20px] max-h-[30vh] focus:outline-none placeholder:text-muted-foreground/50",
        className,
      )}
...
const MCPIcon = (props: React.SVGProps<SVGSVGElement>) => {
  return (
    <svg
